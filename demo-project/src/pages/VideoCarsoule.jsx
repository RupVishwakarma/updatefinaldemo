...
const  VideoCarsoule=()=>{
  return (
   <div className='container-fluid p-4 bg-black'>
    ...
    <div id="carousel-example-controls" class="carousel slide bg-white" data-bs-ride="carousel">
  ...
  <button class="carousel-control-prev" type="button" data-bs-target="#carousel-example-controls" data-bs-slide="prev">
    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
    <span class="visually-hidden">Previous</span>
  </button>
  <button class="carousel-control-next" type="button" data-bs-target="#carousel-example-controls" data-bs-slide="next">
