      ...
      >
        ...
        <div className="form-container">
          {/* <form onSubmit={handleSubmit} encType="multipart/form-data">
            ...
            <div id="register-image" className="mt-3">
          ...
          <form onSubmit={handleSubmit} encType="multipart/form-data">
            ...
            >
              <strong>Welcome to Spreads! Start your journey here</strong>
            </h5>
            <div className="mt-3">
              <input
                type="text"
            ...
            {/* <div id="register-image" className="mt-3 text-center">
              <img
                src={avatarPreview}
                alt="Avatar Preview"
            ...
            <div id="register-image" className="mt-3 text-center">
              ...
              <input
                ...
                name="avatar"
                accept="image/*"
                id="avatarInput" /* Assign an ID to the file input */
                onChange={registerDataChange}
              />
            </div>
            <div className="form-check mt-2">
              ...
              <label
                htmlFor="Checkbox"
                className="form-check-label text-muted text-small"
              >
                People are sharing photos, videos, audio, and stories using
                Spreads. Read and{" "}
                <NavLink to="#">Apply T&C Privacy and Policy</NavLink>.
              </label>
            ...
            <div className="mt-3 d-flex justify-content-center align-items-center">
              <button
                type="submit"
                className="SignUp btn btn-primary btn-sm w-50"
              >
                {loading ? "Loading..." : "Register"}
              </button>
            </div>
