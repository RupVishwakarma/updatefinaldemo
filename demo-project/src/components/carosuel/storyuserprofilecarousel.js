...
import story from "../../assets/banner4.jpeg";
  ...
  return (
    <div className="">
      <img
        ...
        width="90"
        height="90"
        className="img-fluid rounded-circle border border-4 border-danger"
        alt="user story"
        style={{ height: "67px" }}
      />
    </div>
...
const StoryUserCarousel = () => {
  ...
  const chunks = UserArray.reduce(
    (acc, _, i, arr) => (i % 8 === 0 ? [...acc, arr.slice(i, i + 8)] : acc),
    []
  );
