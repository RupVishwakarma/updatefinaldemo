...
export const login = (email, password) => async (dispatch) => {
    try {
        ...
        const { data } = await axiosInstance.post(`/user/login`, { email, password }, config);
...
export const register = (formData) => async (dispatch) => {
    try {
        ...
        const { data } = await axiosInstance.post(`/user/register`, formData, config);
...
export const updateProfile = (userData) => async (dispatch) => {
    try {
       ...
       const { data } = await axiosInstance.put(`/user/update/me`, userData, config);
...
export const searchUser = (query) => async (dispatch) => {
    try {
        ...
        const { data } = await axiosInstance.get(`/user/search?username=${query}`, config);
...
export const updateUserProfile = (id,userData) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axiosInstance.put(`/user/update/${id}`, userData, config);
