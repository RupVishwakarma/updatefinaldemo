...
const Cantact_Spread = lazy(() =>
  import("./components/Community/Cantact_Spread")
);
...
const MassageBox = lazy(() =>
  import("./components/Message/conversation/massage/massage.jsx")
);
const CommentsComponent = lazy(() =>
  import("./components/Comment/CommentsComponents.jsx")
);
    ...
    <div className="App">
      {isAuthenticated && (
        <>
          ...
          <div className={`tab-group ${sideBar ? "show" : ""}`}  ref={sidebarRef}>
